...
import robust from "../../../assets/chain.svg";
...
const Collaborative = () => {
  ...
  return (
    <div className="p-8 lg:p-16 text-center text-white">
      <h2 className="third-title">
        Lybell is collaborative, decentralized <br /> & efficient
      </h2>
      <p className="para">
        Lybell provides decentralized cross-chain collaborative consensus
      </p>
      <div className="flex flex-col mt-4  lg:flex-row lg:gap-16 lg:mt-8">
      ...
      {/* icons */}
      <div class="hideen lg:mt-20 lg:flex lg:flex-wrap lg:justify-center lg:gap-[50px]">
        <div class="flex flex-col items-center mb-10">
          <img
            class="border p-8 rounded-full h-[100px] w-[100px] object-cover"
            src={fast}
            alt=""
          />
